	...
	public register() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				{
					showMessage("First Name Should be Alphabets Only!\n\n");
				}
				else if(!(lastName.matches("^[a-zA-Z]*$")))
				{
					showMessage("Last Name Should be Alphabets Only!\n\n");
				}
				
				else if(!(emailid.matches("^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$")))
				{
					showMessage("Email id should be in this format \n\n abc@xyz.com\n\n");
				}
				
		      
			else if(!(phoneNo.matches("(0/91)?[6-9][0-9]{9}")))
				{
			...
			{
				showMessage("Password Should be minimum 6 character long.\n\n\n");
			}
				
				else 
				{ 
					try {
						 if(reg.checkEmailId(emailid)){
							 showMessage("This EmailId is already registered\n\n Please Log In!\n\n");
								
							}
						 
						 else if(reg.checkPhone(phoneNo))
						 {
							 showMessage("This Mobile Number is already registered\n\n Please Log In!\n\n"); 
						 }
						
						 else if(reg.checkUserName(username)){
