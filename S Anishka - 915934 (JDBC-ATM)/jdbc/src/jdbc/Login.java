...
public class Login extends JFrame {
	...
	public Login() {
		...
		button.setForeground(new Color(128, 134, 128));
		...
		button_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
						...
						try {
							...
							String query="select * from register where username='"+textField.getText()+"' and password='"+passwordField.getText().toString()+"'";
