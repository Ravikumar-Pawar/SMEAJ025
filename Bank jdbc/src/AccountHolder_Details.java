...
public class AccountHolder_Details extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AccountHolder_Details frame = new AccountHolder_Details();
	...
	public AccountHolder_Details() {
		...
		JLabel lblNewLabel = new JLabel("AccountHOLDER DETAILS");
