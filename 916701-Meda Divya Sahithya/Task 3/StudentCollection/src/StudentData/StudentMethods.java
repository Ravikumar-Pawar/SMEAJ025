...
static ArrayList<String> dept=new ArrayList<String>(Arrays.asList("CSE","ECE","EEE","MECH","IT"));
...
static ArrayList<StudentsBean> ITstu=new ArrayList<StudentsBean>();
  ...
  public static void insert_data(ArrayList<StudentsBean> stu,ArrayList<StudentsBean> deptstu,String dept) 
  {
	...
	{	
		...
		{    System.out.println("Count of Students in all Departments:\n");
		     ...
		     System.out.println("Students in IT Departments: "+ITstu.size());
		     break;
		}
		case 6:
