	...
	public AdminPage() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AccountHolders register = new AccountHolders();
		...
		Button button_1 = new Button("Delete Account");
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String name = (String) JOptionPane.showInputDialog(null, null,
							"Enter the ACCHOLDER Name to delete his/her Account", JOptionPane.PLAIN_MESSAGE, null, null,
							null);
