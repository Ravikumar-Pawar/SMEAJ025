...
public class AccountDetails extends JFrame {
	...
	static String url = "jdbc:mysql://localhost:3306/jframe";
	static String uname = "root";
	static String pass = "root";
	int pin;
	String accname1 = UserLogin.getAccName();
	String accpass1 = UserLogin.getAccPass();
	...
	public AccountDetails() {
		try {
			...
			ResultSet rs = statement
					.executeQuery("select * from register where UNAME='" + accname1 + "' and pass='" + accpass1 + "'");
			rs.next();
			pin = rs.getInt("pin");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Object[] ob = { p };
					int result = JOptionPane.showConfirmDialog(null, ob, "Enter your  Previous PIN ",
							JOptionPane.OK_CANCEL_OPTION);
					if (pin == result) {
						int new_pin = JOptionPane.showConfirmDialog(null, ob, "Enter your  NEW PIN ",
								JOptionPane.OK_CANCEL_OPTION);
						int confirm_pin = JOptionPane.showConfirmDialog(null, ob, "RE-Enter your  NEW PIN to confirm ",
								JOptionPane.OK_CANCEL_OPTION);
