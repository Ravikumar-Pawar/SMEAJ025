	...
	public Update() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String result = (String) JOptionPane.showInputDialog(null, null, "Enter your pin ",
				...
				if (result.equals("1234")) {
					try {
						...
						String name = (String) JOptionPane.showInputDialog(null, null,
								"Enter the ACCOUNT HOLDER Name to update  Phone Number", JOptionPane.PLAIN_MESSAGE,
								null, null, null);
						...
						if (!rs.next()) {
							...
							String phone = (String) JOptionPane.showInputDialog(null, null,
									"Enter the   Phone number to update ", JOptionPane.PLAIN_MESSAGE, null, null, null);
							// phone number validation
							Pattern pattern = Pattern.compile("[6-9][0-9]{9}");
							Matcher matcher1 = pattern.matcher(phone);
							if (matcher1.matches()) {
								String query = "update  register  set phone='" + Long.parseLong(phone)
										+ "'where UNAME='" + name + "'";
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (result.equals("1234")) {
					try {
						...
						String name = (String) JOptionPane.showInputDialog(null, null,
								"Enter the ACCOUNT HOLDER Name to update Email", JOptionPane.PLAIN_MESSAGE, null, null,
								null);
						...
						if (!rs.next()) {
							...
							String email = (String) JOptionPane.showInputDialog(null, null, "Enter EMAIL to update ",
							...
							if (matcher2.matches()) {
								...
								JOptionPane.showMessageDialog(null,
										"Sorry!! Cannot able to update Email!\n Enter valid Email!");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (result.equals("1234")) {
					try {
						...
						Statement statement = connection.createStatement();
						String name = (String) JOptionPane.showInputDialog(null, null,
								"Enter the ACCOUNT HOLDER Name to update Address", JOptionPane.PLAIN_MESSAGE, null,
								null, null);
						String que = "select UNAME from register where UNAME='" + name + "'";
						ResultSet rs = statement.executeQuery(que);
						if (!rs.next()) {
							...
							String add = (String) JOptionPane.showInputDialog(null, null, "Enter the ADDRESS to update",
									JOptionPane.PLAIN_MESSAGE, null, null, null);
