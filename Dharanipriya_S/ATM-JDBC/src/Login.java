...
public class Login extends JFrame {
		...
		button_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
						...
						try {
							...
							String query="select * from customerdetails where username='"+textField.getText()+"' and password='"+passwordField.getText().toString()+"'";
	...
	public static String getCustomerPass() {
		return cuspass;
