...
public class AccountDetails extends  JFrame {
	...
	public AccountDetails() {
		...
		ResultSet rs = statement.executeQuery("select * from user_details where username='"+accname1+"' and password='"+accpass1+"'");
		rs.next();
	     pin=rs.getInt("acntpin");
...
//		contentPane.add(lblNewLabel_5);
		...
		Label label_4 = new Label(rs.getString("city"));
		...
		Label label_5 = new Label(rs.getString("username"));
...
//		contentPane.add(label_4_2);
		...
		JLabel lblNewLabel_5_1_1 = new JLabel("BRANCH");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(pin==result) {
					...
					pin=new_pin;
					String que="update customerdetails set acntpin='"+pin+"' where username='"+accname1+"'";
